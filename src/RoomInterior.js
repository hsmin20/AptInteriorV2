...
export class RoomInterior {
    ...
    addSofa_Internal(editor, parent, name, width, height, depth, sofatype, oldPos, oldRot) {
        // Add a group first
        const group = new THREE.Group();
		group.name = name;
        group.userData.isInterior = true;
    ...
    addWashingMachine_Internal(editor, parent, name, width, height, depth, washingMachinetype, oldPos, oldRot) {
        // Add a group first
        const group = new THREE.Group();
		group.name = name;
        group.userData.isInterior = true;
    ...
    `
        ...
        confirmBtn.addEventListener("click", (event) => {
            ...
            this.addSofa_Internal(editor, parent, name, width, height, depth, sofatype, oldPos, oldRot);
        });
    ...
    addWardrobe(editor, modify=false) {
        const _html = `
    ...
    `
        ...
        confirmBtn.addEventListener("click", (event) => {
            ...
            this.addWardrobe_Internal(editor, parent, name, width, height, depth, wardrobetype, noOfDrawers, oldPos, oldRot);
        });

        wardrobeTypeDialog.showModal();
    }

    addWashingMachine(editor, modify=false) {
        const _html = `
    ...
    `
        ...
        confirmBtn.addEventListener("click", (event) => {
           ...
           const washingMachinetype = document.querySelector('input[name=washingMachinetype]:checked').value;
            ...
            this.addWashingMachine_Internal(editor, parent, name, width, height, depth, washingMachinetype, oldPos, oldRot);
        });
